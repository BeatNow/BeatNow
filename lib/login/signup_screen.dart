...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    final ButtonStyle buttonStyle = ElevatedButton.styleFrom(
      foregroundColor: Colors.white, backgroundColor: Color(0xFF3C0F4B),
    ...
    final ButtonStyle socialButtonStyle = ElevatedButton.styleFrom(
      ...
      padding: EdgeInsets.all(16), disabledForegroundColor: Colors.transparent.withOpacity(0.38), disabledBackgroundColor: Colors.transparent.withOpacity(0.12), // Sin efecto al presionar
